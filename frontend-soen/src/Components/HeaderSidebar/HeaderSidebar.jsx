...
function HeaderSidebar() {
  ...
  return (
   <div className="sidebar">
      ...
      <DashboardElement icon={<i className='bx bx-phone-call'></i>} name="Chat" link="/wait" />
      <DashboardElement icon={<i className="bx bx-group"></i>} name="Members" link="/member"/>
      ...
      <DashboardElement icon={<i className="bx bx-plus"></i>} name="App Plus" link="/workout"/>
   </div>
